    ...
    <div>
      <div style={{ display: 'flex' }}>
        ...
        <ul className="nav">
            ...
            <CustomLink to="/InstructorProfile" className="nav-link">
            ...
            <li>
                <li className="nav-item"><CustomLink to="/ManageCourse" className="nav-link">Course Managment</CustomLink></li>
                <li className="nav-item"><CustomLink to="/ContentCreation" className="nav-link">Content Creation</CustomLink></li>
                <li className="nav-item"><CustomLink to="/StudentsAssessment" className="nav-link">Student Assessment</CustomLink></li>
            </li>
