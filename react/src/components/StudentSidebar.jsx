...
export default function StudentSidebar() {
  ...
  return (
    <div>
      ...
      <CustomLink to="/StudentProfile" className="nav-link">
      ...
      <CustomLink to="/UserProgramOveriew" className="nav-link" >
          <span className="menu-title">Program Overview</span>
          <i className="icon-screen-desktop menu-icon"></i>
          </CustomLink>
      </li>
      <li className="nav-item">
      <CustomLink to="/CourseCatalog" className="nav-link" >
          <span className="menu-title">Course Catalog</span>
          <i className="icon-screen-desktop menu-icon"></i>
          </CustomLink>
      </li>
      <li className="nav-item">
      <CustomLink to="/CourseMaterial" className="nav-link" >
          <span className="menu-title">Course Material</span>
          <i className="icon-screen-desktop menu-icon"></i>
          </CustomLink>
      </li>
      <li className="nav-item">
      <CustomLink to="/GiveExam" className="nav-link" >
          <span className="menu-title">Exam Portal</span>
          <i className="icon-screen-desktop menu-icon"></i>
          </CustomLink>
      </li>
      <li className="nav-item">
      <CustomLink to="/StudentProgress" className="nav-link" >
