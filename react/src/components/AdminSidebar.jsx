  ...
  useEffect(() => {
    const fetchAdminDetails = async () => {
      try {
        ...
        const response = await fetch(`https://nxb4401.uta.cloud/php/adminprofile.php/${UserID}`, {
          method: 'GET',
          credentials: 'include',
        });
      ...
      <div style={{ display: 'flex' }}>
        ...
        <nav className="sidebar sidebar-offcanvas" id="sidebar" style={sidebarStyle}>
          <ul className="nav">
            ...
            <li className="nav-item"><CustomLink to="/AdminDashboard" className="nav-link">Admin Dashboard</CustomLink></li>
            <li className="nav-item"><CustomLink to="/ManageCourseProgram" className="nav-link">Manage Course & Program</CustomLink></li>
            <li className="nav-item"><CustomLink to="/ManageStudentAdmin" className="nav-link">Manage Students Account</CustomLink></li>
            <li className="nav-item"><CustomLink to="/ManageInstructorAdmin" className="nav-link">Manage Instructors Account</CustomLink></li>
            <li className="nav-item"><CustomLink to="/ManageQAOAdmin" className="nav-link">Manage QAOs Account</CustomLink></li>
            <li className="nav-item"><CustomLink to="/ManagePCOAdmin" className="nav-link">Manage PCOs Account</CustomLink></li>
            <li className="nav-item">
              <CustomLink to="/GenerateReportAndAnalytics" className="nav-link">
