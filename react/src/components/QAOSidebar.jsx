...
export default function QAOSidebar() {
    ...
    <div>
      <div style={{ display: 'flex' }}>
        ...
        <ul className="nav">
            ...
            <CustomLink to="/QAOProfile" className="nav-link">
            ...
            <li>
                <li className="nav-item"><CustomLink to="/QAOPolicy" className="nav-link">QAO Policies & Processes</CustomLink></li>
                <li className="nav-item"><CustomLink to="/QAOStudentsAssessment" className="nav-link">Student Performance Analysis</CustomLink></li>
                <li className="nav-item"><CustomLink to="/QAOManageStudent" className="nav-link">Manage Students</CustomLink></li>
                <li className="nav-item"><CustomLink to="/QAOManageInstructor" className="nav-link">Manage Instructors</CustomLink></li>
                <li className="nav-item"><CustomLink to="/QAOManageAdmin" className="nav-link">Manage Admins</CustomLink></li>
                <li className="nav-item"><CustomLink to="/QAOManagePCO" className="nav-link">Manage PCODs</CustomLink></li>
