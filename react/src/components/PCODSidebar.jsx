...
export default function PCODSidebar() {
    ...
    <div>
      <div style={{ display: 'flex' }}>
        ...
        <ul className="nav">
            ...
            <CustomLink to="/ProfileProgCOD" className="nav-link">
            ...
            <li className="nav-item nav-category">
              <span className="nav-link">Dashboard</span>
                  ...
                  <li className="nav-item"><CustomLink to="/ManageCourseProgramCOD" className="nav-link">Program Overview & Alignment</CustomLink></li>
                  <li className="nav-item"><CustomLink to="/ProgramEvaluation" className="nav-link">Program Evaluation</CustomLink></li>
            <li className="nav-item nav-category">
